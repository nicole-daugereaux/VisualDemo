...
//            chromeOptions.setExperimentalOption("mobileEmulation", mobileEmulation);
            ...
            sauce.setCapability("name", methodName + " ");
            sauce.setCapability("build", "Visual Example");//enter any string value here if you're running troubleshooting tests to help separate them in your Dashboard
